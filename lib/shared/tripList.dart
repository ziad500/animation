...
class _TripListState extends State<TripList> {
  ...
  void _addTrips() {
    ...
    // future to add item over item in animamtion
  ...
  Widget _buildTile(Trip trip) {
    return ListTile(
      onTap: () {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => Details(trip)));
      },
      ...
      trailing: IconButton(
          ...
          icon: Icon(Icons.add)) /* Text('\$${trip.price}') */,
    );
  }
